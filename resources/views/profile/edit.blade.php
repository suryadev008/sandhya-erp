                    ...
                    <div class="card card-widget widget-user-2 shadow-sm">
                        <div class="widget-user-header bg-primary">
                            <div class="widget-user-image">
                                <div class="bg-white elevation-2 d-flex align-items-center justify-content-center"
                        ...
                        <div class="card-footer p-0">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <span class="nav-link">
                                        Role <span
                                            class="float-right badge bg-success">{{ Auth::user()->getRoleNames()->implode(', ') ?: 'N/A' }}</span>
                                    </span>
                                </li>
                            </ul>
                        </div>
