...
@section('title', config('app.name') . ' | Edit Owner Company')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Owner Company</h1>
            </div>
            <div class="col-sm-6">
        ...
        <form action="{{ route('my-company.update', $company->id) }}" method="POST" enctype="multipart/form-data" id="companyForm" novalidate>
            ...
            <div class="card card-primary card-outline card-outline-tabs">
                        ...
                        <div class="tab-pane fade show active" id="content-info" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" id="pan_number" name="pan_number" class="form-control" value="{{ old('pan_number', $company->pan_number) }}" required>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label>GSTIN <span class="text-danger">*</span></label>
                                    <input type="text" id="gstin" name="gstin" class="form-control" value="{{ old('gstin', $company->gstin) }}" required>
                                </div>
                                <div class="col-md-3 form-group">
                ...
                <div class="card-footer text-right">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Company</button>
                </div>
            </div>
        </form>
    </div>
