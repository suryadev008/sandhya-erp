...
<tr class="contact-row">
    <td>
        <input type="text" name="contacts[{{ $index }}][contact_person]" class="form-control" value="{{ old('contacts.'.$index.'.contact_person', $contact->contact_person ?? '') }}" placeholder="Name">
    </td>
    <td>
    ...
    <td>
        <input type="text" name="contacts[{{ $index }}][phone]" class="form-control" value="{{ old('contacts.'.$index.'.phone', $contact->phone ?? '') }}" placeholder="Phone">
    </td>
    <td>
    ...
    <td>
        <input type="email" name="contacts[{{ $index }}][email]" class="form-control" value="{{ old('contacts.'.$index.'.email', $contact->email ?? '') }}" placeholder="Email">
    </td>
    <td>
