...
@push('styles')
  ...
  <style>
    ...
    .badge-lathe  { background: #007bff; color: #fff; }
    .badge-cnc    { background: #17a2b8; color: #fff; }
    .badge-both   { background: #6f42c1; color: #fff; }
    .half-day-row { background: #fff8e1 !important; }
    .downtime-row { background: #fff3f3 !important; }
  </style>
@endpush
...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="d-none d-print-block mb-3">
      <h4 class="text-center">Attendance Report — {{ $fromDate->format('d M Y') }} to {{ $toDate->format('d M Y') }}</h4>
      @if($employeeId)
