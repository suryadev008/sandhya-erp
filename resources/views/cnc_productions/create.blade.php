...
@section('content')
            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select name="employee_id" id="employee_id" class="form-control select2" required>
                    ...
                    @foreach($employees as $emp)
                      <option value="{{ $emp->id }}" data-payment="{{ $emp->cnc_payment_type }}"
                        data-target="{{ $emp->cnc_target_per_shift }}" data-incentive="{{ $emp->cnc_incentive_rate }}">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="date" name="date" id="entry_date" class="form-control" value="{{ now()->toDateString() }}"
        ...
        <div class="card card-warning card-outline">
          ...
          <div class="card-footer p-0" id="grandTotalBar">
            <div class="px-3 py-2 d-flex justify-content-end align-items-center flex-wrap">
              ...
              <span class="mr-4 text-muted">Total Incentive: <strong id="totalIncentive" class="text-warning">0</strong>
                pcs</span>
  ...
  <template id="rowTemplate">
    <tr class="prod-row">
      ...
      <td class="qty-col">
        <input type="number" name="rows[__IDX__][production_qty]" class="form-control form-control-sm qty-input" min="0"
          value="0" required>
      </td>

      <td>
        <input type="number" name="rows[__IDX__][target_qty]" class="form-control form-control-sm target-input" min="0"
          placeholder="auto">
      ...
      <td>
        <input type="text" name="rows[__IDX__][remark]" class="form-control form-control-sm" placeholder="Optional remark"
          maxlength="500">
      </td>
