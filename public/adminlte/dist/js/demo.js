...
(function ($) {
  ...
  $container.append(
    '<h5>Customize ERP</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<button id="save-theme-btn" class="btn btn-primary btn-block mt-4 mb-4"><i class="fas fa-save"></i> Save Settings</button>')
